    ...
    if (user) {
        ...
        function waitForRef() {
          ...
          if (userInfo) {
            ...
            myProfile.innerHTML = 'My Profile<img src="pizzaslice.jpg" id="buttonPizza">';
...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule("#topcontainer { width: 30%; position:absolute; top: 4%; right: 2%; padding: 6px 12px; display: flex;}", 0);
        ...
        ourtakeSheet.insertRule('.topButtonRight { font-family: "Lato", sans-serif; font-size: 18px; display: inline-block; background: white; color: black; border-radius: 5px; box-shadow: 1px 1px 1px grey; white-space: nowrap; margin: 5px; width: 40%; height: 50px; vertical-align: top; float: right; vertical-align: center; }', 0);
