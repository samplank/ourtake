...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule('.conditional { float: left; padding: 3% 0%; width: 60%; margin: 10px 0px; font-size: 24px; line-height: 34px; font-family: "Frank Ruhl Libre", serif;}', 0);
        ...
        ourtakeSheet.insertRule('h2 { font-family: "Frank Ruhl Libre", serif; font-weight: bold; font-size: 30px; }', 0);
        ourtakeSheet.insertRule('p { font-family: "Frank Ruhl Libre", serif; font-size: 22px; line-height: 34px; }', 0);
    }
    else if (is_mobile) {
        console.log("mobile");
        ...
        ourtakeSheet.insertRule('.conditional { float: left; padding: 3%; width: 95%; margin: 10px 0px; font-size: 24px; line-height: 48px; font-family: "Frank Ruhl Libre", serif;}', 0);
        ...
        ourtakeSheet.insertRule('h2 { font-family: "Frank Ruhl Libre", serif; font-weight: bold; font-size: 40px; }', 0)
        ourtakeSheet.insertRule('p { font-family: "Frank Ruhl Libre", serif; font-size: 22px; line-height: 48px; }', 0);
