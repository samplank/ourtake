    ...
    urlRef.once("value", function(snapshot) {
      snapshot.forEach(function(child) {
        ...
        function waitForBody() {
            if (body != '') {
                aref.innerHTML = "<span style='font-weight:bold; font-size: 28px'>" + contribution.title + '</span><br style="line-height: 40px" />' + body + '<p class="reviewDetails">' + articleDetails + '</p><button>Add to this Article</button>';
