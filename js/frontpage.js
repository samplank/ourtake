...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule("#topLeftFixed { position: absolute; top: 4%; width: 35%; padding: 6px 12px; display: flex;}", 0);
        ...
        ourtakeSheet.insertRule('.topButton {font-family: "Lato", sans-serif; font-size: 22px; display: inline-block; background: white; color: black; border-radius: 3px; box-shadow: 0px 0px 0px grey; white-space: nowrap; margin: 5px; height: 50px; vertical-align: top; float: right; cursor: pointer; width: 40%}', 0);
        ...
        ourtakeSheet.insertRule("#logo { position: absolute; top: 7%; left: 35%; display: block; margin-left: auto; margin-right: auto; width: 30%; }", 0);
