...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule('.conditional { float: left; padding: 3% 0%; width: 60%; margin: 10px 0px; font-size: 24px; line-height: 34px; font-family: Georgia, serif;}', 0);
        ...
        ourtakeSheet.insertRule('.conditional { float: left; padding: 3%; width: 95%; margin: 10px 0px; font-size: 24px; line-height: 48px; font-family: Georgia, serif;}', 0);
        ...
        ourtakeSheet.insertRule('h2 { font-family: Georgia, serif; font-weight: bold; font-size: 40px; }', 0)
