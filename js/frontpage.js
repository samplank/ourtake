...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule('.addToArticle { font-family: "Trebuchet MS", sans-serif; font-size: 22px; display: inline-block; background: #fff4db; color: black; white-space: nowrap; margin: 5px; height: 50px; width: 45%; vertical-align: top; white-space: normal;}', 0);
        ...
        ourtakeSheet.insertRule('.addToArticle { font-family: "Trebuchet MS", sans-serif; font-size: 30px; display: inline-block; background: #fff4db; color: black; white-space: nowrap; margin: 5px; height: 100px; width: 45%; vertical-align: top; white-space: normal;}', 0);
