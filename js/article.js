...
function checkMobile() {
    ...
    if (!is_mobile) {
        ...
        ourtakeSheet.insertRule('.voteButton { background-color: #fff4db; font-family: Georgia, serif; font-size: 18px; width: 30%; height: 50%; margin: 0% 10%;}')
    }
    else if (is_mobile) {
        console.log("mobile");
        ...
        ourtakeSheet.insertRule('#rightjustify { float: right; width: 90%; margin: 10px 0px; font-size: 34px; line-height: 48px;}');
